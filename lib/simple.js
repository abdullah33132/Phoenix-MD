	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363301959563781@newsletter',
            newsletterName: 'كـــيـلــوا 𝓙𝓸𝓐𝓷𝓲𝓶𝓲 𖤍', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363301959563781@newsletter"]
let canalNombre = ["كـــيـلــوا 𝓙𝓸𝓐𝓷𝓲𝓶𝓲 𖤍"]
